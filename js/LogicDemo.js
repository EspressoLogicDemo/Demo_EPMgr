...
var baseUrl="https://livedemo.espressologic.com/rest/demo/Demo_EPMgr/v1/";

// The API key use to access the demo project
var currentApiKey = "wXdNFEDQf5h2mkT";
...
function highlightChanges() {
	for (var j = 0; j < allChanges.length; j++) {
		...
		setTimeout(function() {
			$("#" + allChanges[j]).css("background-color", "");
			$("#" + allChanges[j]).tooltip("hide");
		}, 5000);
	}
	allChanges = [];
}
